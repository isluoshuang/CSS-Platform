...
<template>
  <div id="app">
    ...
    <el-row>
      ...
      <el-col :span="4">
        <div class="btn">
          <el-button type="primary" @click="getSentiment">提交</el-button>
        </div>    
      </el-col>
    </el-row>
    <el-row>
    ...
    <el-row>
      <div class="word">subjectivity代表主观性程度，取值范围是[0, 1]</div>
    </el-row>
    <el-row>
      <el-col :span="20">
